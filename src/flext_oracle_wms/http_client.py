...
class FlextHttpClient:
    ...
    def delete(
        ...
        try:
            ...
            if self._client is None:
                return FlextResult[HttpJsonObject].fail("Client not initialized")
    ...
    def put(
        ...
        try:
            ...
            return FlextResult[HttpJsonObject].fail(f"Unexpected error: {exc}")
