...
class FlextOracleWmsFilter(_OpsFilter):
    """Extend operational filter with back-compat constructor and API."""
    ...
    def _op_like(self, field_value: object, filter_value: object) -> bool:
        ...
        try:
            ...
            flags = 0 if self.case_sensitive else _re.IGNORECASE
            return bool(_re.match(pattern, field_value, flags))
        except Exception:
            return False
