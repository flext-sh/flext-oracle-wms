...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    "FlextOracleWmsApiError": ("flext_oracle_wms._backward_compat", "FlextOracleWmsApiError"),
    "FlextOracleWmsApiResponse": ("flext_oracle_wms.wms_models", "FlextOracleWmsApiResponse"),
    "FlextOracleWmsAuthSettings": ("flext_oracle_wms.wms_auth", "FlextOracleWmsAuthSettings"),
    "FlextOracleWmsAuthenticationError": ("flext_oracle_wms._backward_compat", "FlextOracleWmsAuthenticationError"),
    ...
    "FlextOracleWmsEntityNotFoundError": ("flext_oracle_wms._backward_compat", "FlextOracleWmsEntityNotFoundError"),
    ...
    "FlextOracleWmsInventoryError": ("flext_oracle_wms._backward_compat", "FlextOracleWmsInventoryError"),
    "FlextOracleWmsModels": ("flext_oracle_wms.wms_models", "FlextOracleWmsModels"),
    "FlextOracleWmsPickingError": ("flext_oracle_wms._backward_compat", "FlextOracleWmsPickingError"),
    "FlextOracleWmsProtocols": ("flext_oracle_wms.protocols", "FlextOracleWmsProtocols"),
    "FlextOracleWmsSchemaError": ("flext_oracle_wms._backward_compat", "FlextOracleWmsSchemaError"),
    "FlextOracleWmsSchemaFlatteningError": ("flext_oracle_wms._backward_compat", "FlextOracleWmsSchemaFlatteningError"),
    "FlextOracleWmsSettings": ("flext_oracle_wms.settings", "FlextOracleWmsSettings"),
    "FlextOracleWmsShipmentError": ("flext_oracle_wms._backward_compat", "FlextOracleWmsShipmentError"),
