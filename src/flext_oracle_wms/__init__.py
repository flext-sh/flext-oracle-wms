...
_LAZY_IMPORTS: Mapping[str, Sequence[str]] = {
    ...
    "FlextOracleWmsAuthenticationError": ["flext_oracle_wms.errors", "FlextOracleWmsAuthenticationError"],
    "FlextOracleWmsAuthenticator": ["flext_oracle_wms.wms_auth", "FlextOracleWmsAuthenticator"],
    "FlextOracleWmsClient": ["flext_oracle_wms.wms_client", "FlextOracleWmsClient"],
    "FlextOracleWmsClientSettings": ["flext_oracle_wms.settings", "FlextOracleWmsClientSettings"],
    "FlextOracleWmsConfigurationError": ["flext_oracle_wms.errors", "FlextOracleWmsConfigurationError"],
    "FlextOracleWmsConnectionError": ["flext_oracle_wms.errors", "FlextOracleWmsConnectionError"],
    "FlextOracleWmsConstants": ["flext_oracle_wms.constants", "FlextOracleWmsConstants"],
    "FlextOracleWmsDataValidationError": ["flext_oracle_wms._utilities.filtering", "FlextOracleWmsDataValidationError"],
    "FlextOracleWmsEntityDiscovery": ["flext_oracle_wms.wms_discovery", "FlextOracleWmsEntityDiscovery"],
    "FlextOracleWmsEntityNotFoundError": ["flext_oracle_wms.errors", "FlextOracleWmsEntityNotFoundError"],
    ...
    "FlextOracleWmsFilterOperator": ["flext_oracle_wms._utilities.filtering", "FlextOracleWmsFilterOperator"],
    "FlextOracleWmsInventoryError": ["flext_oracle_wms.errors", "FlextOracleWmsInventoryError"],
    "FlextOracleWmsModels": ["flext_oracle_wms.models", "FlextOracleWmsModels"],
    "FlextOracleWmsOperatorFilter": ["flext_oracle_wms._utilities.filtering", "FlextOracleWmsOperatorFilter"],
    "FlextOracleWmsPickingError": ["flext_oracle_wms.errors", "FlextOracleWmsPickingError"],
    "FlextOracleWmsProcessingError": ["flext_oracle_wms.errors", "FlextOracleWmsProcessingError"],
    "FlextOracleWmsProtocols": ["flext_oracle_wms.protocols", "FlextOracleWmsProtocols"],
    "FlextOracleWmsSchemaError": ["flext_oracle_wms.errors", "FlextOracleWmsSchemaError"],
    "FlextOracleWmsSchemaFlatteningError": ["flext_oracle_wms.errors", "FlextOracleWmsSchemaFlatteningError"],
    "FlextOracleWmsSettings": ["flext_oracle_wms.settings", "FlextOracleWmsSettings"],
    "FlextOracleWmsShipmentError": ["flext_oracle_wms.errors", "FlextOracleWmsShipmentError"],
    "FlextOracleWmsTypes": ["flext_oracle_wms.typings", "FlextOracleWmsTypes"],
    "FlextOracleWmsUtilities": ["flext_oracle_wms.utilities", "FlextOracleWmsUtilities"],
    "FlextOracleWmsUtilitiesAuth": ["flext_oracle_wms._utilities.auth", "FlextOracleWmsUtilitiesAuth"],
    "FlextOracleWmsUtilitiesClient": ["flext_oracle_wms._utilities.client", "FlextOracleWmsUtilitiesClient"],
    "FlextOracleWmsUtilitiesDiscovery": ["flext_oracle_wms._utilities.discovery", "FlextOracleWmsUtilitiesDiscovery"],
    "FlextOracleWmsUtilitiesFiltering": ["flext_oracle_wms._utilities.filtering", "FlextOracleWmsUtilitiesFiltering"],
    "FlextOracleWmsUtilitiesHttpClient": ["flext_oracle_wms._utilities.http_client", "FlextOracleWmsUtilitiesHttpClient"],
    "FlextOracleWmsValidationError": ["flext_oracle_wms.errors", "FlextOracleWmsValidationError"],
    ...
    "create_flext_http_client": ["flext_oracle_wms.http_client", "create_flext_http_client"],
    "d": ["flext_core", "d"],
    "e": ["flext_core", "e"],
    "h": ["flext_core", "h"],
