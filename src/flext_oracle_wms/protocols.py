...
class FlextOracleWmsProtocols(FlextProtocols):
    ...
    @runtime_checkable
    class WmsClientProtocol(FlextProtocols.Service, Protocol):
    ...
    @runtime_checkable
    class EntityDiscoveryProtocol(FlextProtocols.Service, Protocol):
    ...
    @runtime_checkable
    class InventoryManagementProtocol(FlextProtocols.Service, Protocol):
    ...
    @runtime_checkable
    class ShippingOperationsProtocol(FlextProtocols.Service, Protocol):
    ...
    @runtime_checkable
    class DataProcessingProtocol(FlextProtocols.Service, Protocol):
