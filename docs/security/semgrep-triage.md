...
| 4 | medium | high | `uv-missing-dependency-cooldown` | `pyproject.toml` | 603 | |
...
Dados brutos: `~/semgrep-violations/by-repo/flext-sh__flext-oracle-wms.json`
