...
class TestFlextOracleWmsAuth:
    ...
    def test_auth_flow_invalid_credentials(self):
...
class TestFlextOracleWmsLegacyClient:
    ...
    def test_build_api_url_with_record_id(self):
    ...
    @patch('httpx.Client.get')
    def test_discover_entities_success(self, mock_get):
    ...
    @patch('httpx.Client.get')
    def test_discover_entities_fallback(self, mock_get):
    ...
    @patch('httpx.Client.get')
    def test_get_entity_data_success(self, mock_get):
    ...
    def test_write_entity_data_success(self, mock_post):
    ...
    @patch('httpx.Client.get')
    def test_bulk_get_entities_success(self, mock_get):
    ...
    @patch('httpx.Client.post')
    def test_bulk_post_records_success(self, mock_post):
    ...
    def test_operation_tracking_failure(self):
    ...
    def test_bulk_operations_integration_validation(self):
