...
class TestsFlextOracleWmsFiltering:
    ...
    def test_filter_invalid_max_conditions_zero(self) -> None:
        with pytest.raises(e.BaseError, match="Invalid max_conditions"):
            FlextOracleWmsUtilitiesFiltering.Filter(max_conditions=0)

    def test_filter_invalid_max_conditions_negative(self) -> None:
        with pytest.raises(e.BaseError, match="Invalid max_conditions"):
            FlextOracleWmsUtilitiesFiltering.Filter(max_conditions=-1)
    ...
    def test_filter_with_initial_filters(self) -> None:
        ...
        filters: t.MappingKV[str, t.OracleWms.FilterScalar | t.OracleWms.FilterList] = {
            "status": "active",
        }
        filter_engine = FlextOracleWmsUtilitiesFiltering.Filter(
            filters=filters, max_conditions=50
        )
    ...
    def test_filter_with_too_many_initial_filters(self) -> None:
        ...
        filters: t.MappingKV[str, t.OracleWms.FilterScalar] = {
            "field1": "v1",
            "field2": "v2",
            "u.field3": "v3",
            "u.field4": "v4",
    ...
    @property
    def sample_records(self) -> t.SequenceOf[t.OracleWms.FilterRecord]:
    ...
    @property
    def nested_records(self) -> t.SequenceOf[t.OracleWms.FilterRecord]:
    ...
    def test_filter_records_with_operator_dict(self) -> None:
        ...
        filters: t.MappingKV[str, m.OracleWms.FlextOracleWmsOperatorFilter] = {
    ...
    @property
    def unsorted_records(self) -> t.SequenceOf[t.OracleWms.FilterRecord]:
    ...
    def test_sort_records_with_none_values(self) -> None:
        ...
        records_with_none: t.SequenceOf[t.OracleWms.FilterRecord] = [
    ...
    def test_create_filter_invalid_max_conditions(self) -> None:
        with pytest.raises(e.BaseError, match="Invalid max_conditions"):
            FlextOracleWmsUtilitiesFiltering.Filter.create_filter(max_conditions=0)
    ...
    def test_filter_large_record_set(self) -> None:
        ...
        large_records: t.SequenceOf[t.OracleWms.FilterRecord] = [
    ...
    def test_filter_with_complex_nested_data(self) -> None:
        ...
        complex_records: t.SequenceOf[t.OracleWms.FilterRecord] = [
    ...
    def test_check_min_and_max_static_methods(self) -> None:
        assert FlextOracleWmsUtilitiesFiltering.Filter._check_min(5, 3) is True
        assert FlextOracleWmsUtilitiesFiltering.Filter._check_min(3, 5) is False
        assert FlextOracleWmsUtilitiesFiltering.Filter._check_min(5, 5) is True
        assert FlextOracleWmsUtilitiesFiltering.Filter._check_max(3, 5) is True
        assert FlextOracleWmsUtilitiesFiltering.Filter._check_max(5, 3) is False
        assert FlextOracleWmsUtilitiesFiltering.Filter._check_max(5, 5) is True
        assert FlextOracleWmsUtilitiesFiltering.Filter._check_min("b", "a") is True
        assert FlextOracleWmsUtilitiesFiltering.Filter._check_min("a", "b") is False
        assert FlextOracleWmsUtilitiesFiltering.Filter._check_max("a", "b") is True
        assert FlextOracleWmsUtilitiesFiltering.Filter._check_max("b", "a") is False
        assert FlextOracleWmsUtilitiesFiltering.Filter._check_min("a", 1) is True
        assert FlextOracleWmsUtilitiesFiltering.Filter._check_max("a", 1) is False
