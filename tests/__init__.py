...
_LAZY_IMPORTS: Mapping[str, Sequence[str]] = {
    ...
    "FlextOracleWmsAuthSettings": ["tests.test_authentication", "FlextOracleWmsAuthSettings"],
    ...
    "create_oracle_wms_client": ["tests.test_authentication", "create_oracle_wms_client"],
    "d": ["flext_tests", "d"],
    "e": ["flext_tests", "e"],
