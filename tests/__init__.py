...
_LAZY_IMPORTS: Mapping[str, Sequence[str]] = {
    ...
    "FlextOracleWmsAuthSettings": ["tests.test_authentication_core", "FlextOracleWmsAuthSettings"],
    ...
    "create_oracle_wms_client": ["tests.test_authentication_core", "create_oracle_wms_client"],
    "d": ["flext_tests", "d"],
    "e": ["flext_tests", "e"],
    ...
    "test_config_auth_fields_default_empty": ["tests.test_config", "test_config_auth_fields_default_empty"],
