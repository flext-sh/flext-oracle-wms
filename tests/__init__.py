...
if TYPE_CHECKING:
    ...
    from tests.constants import TestsFlextOracleWmsConstants
    from tests.models import TestsFlextOracleWmsModels, m, tm
    ...
    from tests.test_unified_config import TestFlextOracleWmsSettings
    from tests.typings import TestsFlextOracleWmsTypes, TestsFlextOracleWmsTypes as t
    from tests.unit.test_constants import TestFlextOracleWmsConstants as c
    from tests.unit.test_wms_api import TestFlextOracleWmsApi
    from tests.unit.test_wms_client import TestFlextOracleWmsClient
    from tests.utilities import TestsFlextOracleWmsUtilities

# Lazy import mapping: export_name -> (module_path, attr_name)
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    "CompleteMockPipeline": ("tests.complete_mock_pipeline", "CompleteMockPipeline"),
    "FlextOracleWmsApiCategory": ("tests.test_declarative", "FlextOracleWmsApiCategory"),
    "FlextOracleWmsApiVersion": ("tests.test_declarative", "FlextOracleWmsApiVersion"),
    "FlextOracleWmsClientSettings": ("tests.test_declarative", "FlextOracleWmsClientSettings"),
    "FocusedOracleWmsDiscovery": ("tests.oracle_wms_focused_discovery", "FocusedOracleWmsDiscovery"),
    "OptimizedOracleWmsDiscovery": ("tests.oracle_wms_optimized_discovery", "OptimizedOracleWmsDiscovery"),
    "OracleWmsCompleteDiscovery": ("tests.oracle_wms_complete_discovery", "OracleWmsCompleteDiscovery"),
    "TestApplyOperator": ("tests.test_filtering", "TestApplyOperator"),
    "TestAuthenticationConfig": ("tests.test_authentication_core", "TestAuthenticationConfig"),
    "TestAuthenticationMethod": ("tests.test_authentication_core", "TestAuthenticationMethod"),
    "TestAuthenticator": ("tests.test_authentication_core", "TestAuthenticator"),
    "TestAutomationApisIntegration": ("tests.test_declarative", "TestAutomationApisIntegration"),
    ...
    "TestEndpointDiscoveryStrategyEnum": ("tests.test_discovery", "TestEndpointDiscoveryStrategyEnum"),
    "TestErrorHandling": ("tests.test_filtering", "TestErrorHandling"),
    "TestErrorHandlingIntegration": ("tests.test_declarative", "TestErrorHandlingIntegration"),
    ...
    "TestFlextOracleWmsApiResponse": ("tests.test_singer_flattening", "TestFlextOracleWmsApiResponse"),
    "TestFlextOracleWmsClient": ("tests.unit.test_wms_client", "TestFlextOracleWmsClient"),
    "TestFlextOracleWmsClientCore": ("tests.test_client_core", "TestFlextOracleWmsClientCore"),
    "TestFlextOracleWmsConstants": ("tests.test_schema_dynamic", "TestFlextOracleWmsConstants"),
    "TestFlextOracleWmsEntity": ("tests.test_singer_flattening", "TestFlextOracleWmsEntity"),
    "TestFlextOracleWmsEntityDiscovery": ("tests.test_discovery", "TestFlextOracleWmsEntityDiscovery"),
    "TestFlextOracleWmsFilterConstruction": ("tests.test_filtering", "TestFlextOracleWmsFilterConstruction"),
    "TestFlextOracleWmsSettings": ("tests.test_unified_config", "TestFlextOracleWmsSettings"),
    "TestFlextOracleWmsUtilities": ("tests.test_helpers_core", "TestFlextOracleWmsUtilities"),
    ...
    "TestOracleWmsDeclarativeIntegration": ("tests.test_declarative", "TestOracleWmsDeclarativeIntegration"),
    "TestPerformanceAndEdgeCases": ("tests.test_filtering", "TestPerformanceAndEdgeCases"),
    "TestPerformanceIntegration": ("tests.test_declarative", "TestPerformanceIntegration"),
    ...
    "run_complete_discovery": ("tests.oracle_wms_complete_discovery", "run_complete_discovery"),
    "run_optimized_discovery": ("tests.oracle_wms_optimized_discovery", "run_optimized_discovery"),
    ...
    "test_api_response_validate_response_failure": ("tests.test_models", "test_api_response_validate_response_failure"),
    "test_api_response_validate_response_success": ("tests.test_models", "test_api_response_validate_response_success"),
    "test_api_response_with_nested_data": ("tests.test_models", "test_api_response_with_nested_data"),
    "test_client_class_creation": ("tests.test_client_class", "test_client_class_creation"),
    "test_client_config_access": ("tests.test_client_class", "test_client_config_access"),
    "test_client_has_discovery_methods": ("tests.test_client_class", "test_client_has_discovery_methods"),
    "test_client_has_http_methods": ("tests.test_client_class", "test_client_has_http_methods"),
    "test_client_has_lifecycle_methods": ("tests.test_client_class", "test_client_has_lifecycle_methods"),
    "test_client_has_wms_operations": ("tests.test_client_class", "test_client_has_wms_operations"),
    "test_client_internal_state": ("tests.test_client_class", "test_client_internal_state"),
    ...
    "test_config_custom_values": ("tests.test_config_module", "test_config_custom_values"),
    "test_config_defaults_from_constants": ("tests.test_config", "test_config_defaults_from_constants"),
    "test_config_enterprise_features": ("tests.test_config", "test_config_enterprise_features"),
    "test_config_environment_from_url": ("tests.test_config", "test_config_environment_from_url"),
    "test_config_optional_auth_fields": ("tests.test_config", "test_config_optional_auth_fields"),
    "test_config_reset_functionality": ("tests.test_config_module", "test_config_reset_functionality"),
    "test_config_singleton_behavior": ("tests.test_config_module", "test_config_singleton_behavior"),
    "test_config_testing_factory": ("tests.test_config_module", "test_config_testing_factory"),
    "test_config_validate_config_success": ("tests.test_config", "test_config_validate_config_success"),
    ...
    "test_entity_validate_entity_success": ("tests.test_models", "test_entity_validate_entity_success"),
    "test_entity_validation_bad_endpoint_raises": ("tests.test_models", "test_entity_validation_bad_endpoint_raises"),
    "test_entity_validation_empty_name_raises": ("tests.test_models", "test_entity_validation_empty_name_raises"),
