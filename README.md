...
**Version**: `unknown` | **Python**: 3.13+ | **Project class**: `domain`
...
- Primary facades: `FlextOracleWmsUtilitiesClient`, `FlextOracleWmsConnectionError`, `FlextOracleWmsUtilities`, `FlextOracleWmsValidationError`, `FlextOracleWmsAuthenticationError`, `FlextOracleWmsTypes` (+14 more)
...
2. Confirm parent MRO chain via `pyproject.toml` `dependencies` filtered by `flext-*` (excluding `flext-oracle-wms` self).
...
- Public extensions exposed by this project: `FlextOracleWmsUtilitiesClient`, `FlextOracleWmsConnectionError`, `FlextOracleWmsUtilities`, `FlextOracleWmsValidationError`, `FlextOracleWmsAuthenticationError`, `FlextOracleWmsTypes` (+14 more).
